...
const OngingProfile = ({ isOpen, setIsOpen, selectData}) => {
  ...
  <>
   {isOpen && (
     <div className="fixed inset-0 h-[1600px] top-0 z-50 flex items-center justify-center bg-black bg-opacity-10">
     <div className="w-[700px] h-[660px] z-10 pl-[28px] pt-4 top-[23%] rounded-[10px] absolute  left-1/2 -translate-x-[50%] -translate-y-[50%] bg-white shadow-[2px_4px_14px_2px_rgba(0,0,0,0.25)]">
            ...
            <div className="flex gap-5">
              ...
              <div class="flex  flex-row space-y-4 h-[59px] items-center">
                <div className="flex flex-col justify-end ">
                 <div  className="relative"><button onClick={closeModal} className=" absolute left-[280%] text-2xl ">&times;</button></div>
                  <div className=" flex flex-row space-x-4 pb-[10px]">
                      
<div className="flex text-[19px] flex-col space-x-2 font-semibold">
  {selectData.company}, India  {/* Update this line to display the company name */}
